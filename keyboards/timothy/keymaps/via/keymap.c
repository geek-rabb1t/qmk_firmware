...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+--------+------+------+------|      |------+------+------+--------+------+-------------|
   * |  SET |  GUI |  Alt |SFT/F13 | Space|CURSOR|                    |CURSOR| Enter|SFT/F14 |   [  |  ]   | SLEEP|
   * ,--------------------------------------------------.      ,--------------------------------------------------.
   */
  [_BASE] = LAYOUT(
     ...
     KC_LCTL , KC_Z       , KC_X    , KC_C    , KC_V         , KC_B   , KC_DEL       , KC_F12       , KC_N   , KC_M          , KC_COMM , KC_DOT  , KC_SLSH , KC_BSLS , \
               DF(_ADJUST), KC_LGUI , KC_LALT ,LSFT_T(KC_F13), KC_SPC , MO(_L1)      , MO(_L1)      , KC_ENT , RSFT_T(KC_F14), KC_LBRC , KC_RBRC , KC_SLEP             \
  ),
